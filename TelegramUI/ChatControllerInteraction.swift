...
public final class ChatControllerInteraction {
    ...
    let handleMessagesWithBots: ([Message]?, Bool) -> Void
    let showBotDetails: (AiGramBot, @escaping () -> Void) -> Void
    let showBotActions: (AiGramBot, @escaping () -> Void) -> Void
    let buyBot: (AiGramBot, @escaping (Bool) -> Void) -> Void
    /// Suggestion, Tag, Name
    let handleSuggestionTap: (String, String, AiGramBot.ChatBotId) -> Void
    ...
    init(openMessage: @escaping (Message, ChatControllerInteractionOpenMessageMode) -> Bool, openPeer: @escaping (PeerId?, ChatControllerInteractionNavigateToPeer, Message?) -> Void, openPeerMention: @escaping (String) -> Void, openMessageContextMenu: @escaping (Message, ASDisplayNode, CGRect) -> Void, navigateToMessage: @escaping (MessageId, MessageId) -> Void, clickThroughMessage: @escaping () -> Void, toggleMessagesSelection: @escaping ([MessageId], Bool) -> Void, sendMessage: @escaping (String) -> Void, sendSticker: @escaping (FileMediaReference, Bool) -> Void, sendGif: @escaping (FileMediaReference) -> Void, requestMessageActionCallback: @escaping (MessageId, MemoryBuffer?, Bool) -> Void, activateSwitchInline: @escaping (PeerId?, String) -> Void, openUrl: @escaping (String, Bool, Bool?) -> Void, shareCurrentLocation: @escaping () -> Void, shareAccountContact: @escaping () -> Void, sendBotCommand: @escaping (MessageId?, String) -> Void, openInstantPage: @escaping (Message) -> Void, openHashtag: @escaping (String?, String) -> Void, updateInputState: @escaping ((ChatTextInputState) -> ChatTextInputState) -> Void, updateInputMode: @escaping ((ChatInputMode) -> ChatInputMode) -> Void, openMessageShareMenu: @escaping (MessageId) -> Void, presentController: @escaping  (ViewController, Any?) -> Void, navigationController: @escaping () -> NavigationController?, presentGlobalOverlayController: @escaping (ViewController, Any?) -> Void, callPeer: @escaping (PeerId) -> Void, longTap: @escaping (ChatControllerInteractionLongTapAction) -> Void, openCheckoutOrReceipt: @escaping (MessageId) -> Void, openSearch: @escaping () -> Void, setupReply: @escaping (MessageId) -> Void, canSetupReply: @escaping (Message) -> Bool, navigateToFirstDateMessage: @escaping(Int32) ->Void, requestRedeliveryOfFailedMessages: @escaping (MessageId) -> Void, addContact: @escaping (String) -> Void, requestMessageUpdate: @escaping (MessageId) -> Void, cancelInteractiveKeyboardGestures: @escaping () -> Void, automaticMediaDownloadSettings: AutomaticMediaDownloadSettings, handleMessagesWithBots: @escaping ([Message]?, Bool) -> Void, showBotDetails: @escaping (AiGramBot, @escaping () -> Void) -> Void, buyBot: @escaping (AiGramBot, @escaping (Bool) -> Void) -> Void, showBotActions: @escaping (AiGramBot, @escaping () -> Void) -> Void, handleSuggestionTap: @escaping (String, String, AiGramBot.ChatBotId) -> Void) {
        ...
        self.handleMessagesWithBots = handleMessagesWithBots
        self.showBotDetails = showBotDetails
        self.buyBot = buyBot
        self.showBotActions = showBotActions
        self.handleSuggestionTap = handleSuggestionTap
    }
}
