...
public final class ChatControllerInteraction {
    ...
    let handleMessagesWithBots: ([String]?) -> Void
    let showBotDetails: (ChatBot) -> Void
    let showBotActions: (ChatBot) -> Void
