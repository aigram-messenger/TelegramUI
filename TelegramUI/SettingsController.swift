    ...
    func item(_ arguments: SettingsItemArguments) -> ListViewItem {
        switch self {
            ...
            case let .autosuggestions(theme, icon, text):
                return ItemListSwitchItem(theme: theme, icon: icon, title: text, value: ChatBotsManager.shared.autoOpenBots, enableInteractiveChanges: true, enabled: true, sectionId: ItemListSectionId(self.section), style: .blocks, updated: { value in
...
//        NOTE: In AiGram this fields are not available
