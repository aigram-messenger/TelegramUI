...
final class ChatListSelectionController: ViewController {
    ...
    var result: Signal<[ChatListSelectionPeerId], NoError> {
    ...
    override func loadDisplayNode() {
        self.displayNode = ChatSelectionControllerNode(account: self.account, options: self.options, filters: filters)
...
//                }
    ...
    override func containerLayoutUpdated(_ layout: ContainerViewLayout, transition: ContainedViewLayoutTransition) {
        ...
        self.chatsNode.containerLayoutUpdated(layout, navigationBarHeight: self.navigationHeight, transition: transition)
    }
