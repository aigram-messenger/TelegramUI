...
final class ChatBotsInputNodeInteraction {
    ...
    /// Suggestion, Tag, Name
    let sendMessage: (String, String, AiGramBot.ChatBotId) -> Void
    ...
    init(navigateToCollectionId: @escaping (ItemCollectionId) -> Void, sendMessage: @escaping (String, String, AiGramBot.ChatBotId) -> Void, buyBot: @escaping (AiGramBot) -> Void,
