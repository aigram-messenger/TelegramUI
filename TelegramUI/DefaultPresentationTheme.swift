...
private func makeDefaultAiGramPresentationTheme(accentColor: UIColor, day: Bool) -> PresentationTheme {
...
public let defaultPresentationTheme = makeDefaultAiGramPresentationTheme(accentColor: UIColor(rgb: 0x00C6B6), day: false)
...
func makeDefaultDayPresentationTheme(accentColor: Int32?) -> PresentationTheme {
    ...
    return accentColor == nil
        ? makeDefaultAiGramPresentationTheme(accentColor: color, day: true)
        : makeDefaultPresentationTheme(accentColor: color, day: true)
}
