//
//  ChatBotsStoreSearchBar.swift
//  TelegramUI
//
//  Created by Dmitry Shelonin on 31/01/2019.
...
private class ChatBotsStoreSearchBarTextField: UITextField {
...
class ChatBotsStoreSearchBar: ASDisplayNode, UITextFieldDelegate {
    var cancel: (() -> Void)?
    ...
    private let textField: ChatBotsStoreSearchBarTextField
    ...
    init(theme: PresentationTheme, strings: PresentationStrings) {
        ...
        self.textField = ChatBotsStoreSearchBarTextField()
    ...
    func animateIn(from node: ChatBotStoreSearchPlaceholderListItemNode, duration: Double, timingFunction: String) {
    ...
    func transitionOut(to node: ChatBotStoreSearchPlaceholderListItemNode, transition: ContainedViewLayoutTransition, completion: @escaping () -> Void) {
